...
\* Have a basic understanding on how to decide on model aspects and find the required information
...
**What unit does m3/s become if I multiply it with ‘1000x3600x24x365.25’ ?**
...
pars <- list(
  ...
  U2       = 1.0, # [m2/s2] the mean of the square of windspeeds over the Otago harbour
  TC       = 15.0, # [degC] the temperature of Otago harbour water
  S        = 35.0, # [-] the salinity of Otago harbour water
...
There are no reactions yet in the model, so why does the model predict a sea-air $CO_2$ flux? Think about what is already included in the model, and how acid-base and air-sea exchange works. **Answer the question in your report template**.
...
Have a look at the code chunk below - does the code make sense to you? Look at line 54 ('ddt.TA.harbour <- ...') Why does inorganic carbon (=$CaCO_3$) burial remove 2x as much alkalinity? **Answer the question in your report template**
